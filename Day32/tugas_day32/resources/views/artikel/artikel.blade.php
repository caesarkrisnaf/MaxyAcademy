...
@push('meta')
<meta name="description" content="{{ Str::of($artikel->konten)->limit(120) }}">
  <meta name="author" content="{{$artikel->user->name}}">
  <meta property="og:url" content="{{ url()->current() }}" />
  <meta property="og:type" content="article" />
  <meta property="og:title" content="Artikel {{ $artikel->judul }}" />
  <meta property="og:image" content="/upload/post/{{$artikel->sampul}}" />
  <meta property="og:description" content="{{ Str::of($artikel->konten)->limit(120)}}" />
