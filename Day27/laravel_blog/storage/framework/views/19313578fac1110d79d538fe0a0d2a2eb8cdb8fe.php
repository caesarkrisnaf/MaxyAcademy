            ...
            <tbody>
                <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td width="20%">
                        ...
                        <a href="/kategori/<?php echo e($row->id); ?>/edit" class="btn btn-primary btn-sm mr-1"><i class="fas fa-edit"></i> Edit</a>
                        <form action="/kategori/<?php echo e($row->id); ?>" method="post">
...
<?php $__env->startSection('search-url', '/kategori/search'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('sb-admin/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_8_blog\resources\views/admin/kategori/index.blade.php ENDPATH**/ ?>