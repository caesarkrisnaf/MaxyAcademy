...
@push('meta')
<meta name="description" content="Temukan artikel terbaru dan terlengkap tentang teknologi IT. Laravel Blog adalah sumber informasi terpercaya untuk para antusias IT">
  <meta name="author" content="Caesar Krisna">
  <meta property="og:url" content="{{ url()->current() }}" />
  <meta property="og:image" content="http://localhost:8000/upload/logo/logo.png" />
  <meta property="og:description" content="Temukan artikel terbaru dan terlengkap tentang teknologi IT. Laravel Blog adalah sumber informasi terpercaya untuk para antusias IT" />
...
@isset($tag_dipilih)
    @push('meta')
  <meta property="og:title" content="Tag {{$tag_dipilih->nama}}" />
    @endpush
     @section('title')
...
@isset($kategori_dipilih)
    @push('meta')   
  <meta property="og:title" content="Kategori : {{$kategori_dipilih->nama}}" />
    @endpush
    @section('title')
...
@isset($author_dipilih)
    @push('meta')   
  <meta property="og:title" content="Author : {{$author_dipilih->name}}" />
    @endpush
    @section('title')
...
@isset($home)
    @push('meta')   
  <meta property="og:title" content="Semua Post" />
    @endpush
